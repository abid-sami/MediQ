...
export function BloodBankProfileModule({
  ...
  const [formData, setFormData] = useState<BloodBankStaffProfile>(profile);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs opacity-80 mt-0.5">{formData.facility}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="details" className="w-full">
        <TabsList className="bg-card border border-border p-1 rounded-xl mb-6">
          <TabsTrigger value="details" className="rounded-lg text-xs font-semibold">
            <User className="mr-1.5 h-3.5 w-3.5 text-primary" /> Edit Officer Credentials
          </TabsTrigger>
