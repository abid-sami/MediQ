...
export function NurseProfileModule({
  ...
  const [formData, setFormData] = useState<NurseProfile>(profile);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs opacity-80 mt-0.5">{formData.ward}</p>
            </div>
          </div>
      ...
      <Tabs defaultValue="details" className="w-full">
        <TabsList className="bg-card border border-border p-1 rounded-xl mb-6">
          <TabsTrigger value="details" className="rounded-lg text-xs font-semibold">
            <User className="mr-1.5 h-3.5 w-3.5 text-primary" /> Edit Nurse Credentials
          </TabsTrigger>
